...
public class MapInterfaceDemo {
    public static void main(String[] args) {
        ...
        // 1. Basic Operations - Adding elements
        hashMap.put("Apple", 1);
        ...
        System.out.println("Default value for Mango: " + hashMap.getOrDefault("Mango", 0));
